...
//     componentsData:TComponentsDataType,
//     getComponent(name:string):componentObjectType
// }
...
class General {
    ...
    getComponent(name:string):ComponentObjectType | null {
       if( !name) return null
        return this.componentsData[name as keyof TComponentsDataType]
    ...
    getSelectedComponentName(element: HTMLElement, ancestorIdentifier='.rooms', elementSelector='p'):string | null {
        ...
        const name = selectedElement? selectedElement?.textContent?.toLowerCase(): null;
        return name;
    }

    getComponentData(element:HTMLElement, ancestorIdentifier:string, childElement: string):ComponentObjectType | null {
    ...
    closestSelector(selectedElement: HTMLElement, ancestorIdentifier:string, childSelector:string):HTMLElement| HTMLInputElement| null {
